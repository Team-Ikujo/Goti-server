...
public enum ErrorCode {
	...
	SEAT_HOLD_GAME_MISMATCH(HttpStatus.BAD_REQUEST, "요청한 경기와 hold 정보가 일치하지 않습니다."),
	SEAT_HOLD_STATUS_INVALID(HttpStatus.BAD_REQUEST, "점유 중인 좌석만 주문할 수 있습니다."),
	SEAT_HOLD_EXPIRED(HttpStatus.BAD_REQUEST, "만료된 hold는 주문할 수 없습니다."),
	...
	DUPLICATE_HOLD_ID_REQUEST(HttpStatus.BAD_REQUEST, "중복된 hold ID는 허용되지 않습니다."),
